...
| 2b | `/tasks` | @task-splitter | Reads `docs/pipeline/plan/` and `.feature` files, decomposes into atomic tasks in `docs/pipeline/tasks.md`. Sets phase to "implementation". |
...
```jsonc
{
  ...
  "agent": {
    ...
    "task-archiver":        { "model": "opencode-go/deepseek-v4-flash", "mode": "subagent" },
